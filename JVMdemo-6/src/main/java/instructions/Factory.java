...
import instructions.comparisons.if_acmp.IF_ACMPEQ;
import instructions.comparisons.if_acmp.IF_ACMPNE;
import instructions.comparisons.if_icmp.*;
import instructions.comparisons.if_icmp.IF_ICMPEQ;
import instructions.comparisons.if_icmp.IF_ICMPGE;
import instructions.comparisons.if_icmp.IF_ICMPGT;
import instructions.comparisons.if_icmp.IF_ICMPLE;
import instructions.comparisons.if_icmp.IF_ICMPLT;
import instructions.comparisons.if_icmp.IF_ICMPNE;
import instructions.comparisons.ifcond.*;
import instructions.comparisons.ifcond.IFEQ;
import instructions.comparisons.ifcond.IFGE;
import instructions.comparisons.ifcond.IFGT;
import instructions.comparisons.ifcond.IFLE;
import instructions.comparisons.ifcond.IFLT;
import instructions.comparisons.ifcond.IFNE;
import instructions.comparisons.lcmp.LCMP;
import instructions.constants.consts.*;
import instructions.constants.consts.ACONST_NULL;
import instructions.constants.ipush.BIPUSH;
import instructions.constants.ipush.SIPUSH;
import instructions.constants.nop.NOP;
import instructions.control.GOTO;
import instructions.control.LOOKUP_SWITCH;
import instructions.control.TABLE_SWITCH;
import instructions.control.rtn.ARETURN;
import instructions.control.rtn.RETURN;
import instructions.control.rtn.LRETURN;
import instructions.control.rtn.FRETURN;
import instructions.control.rtn.IRETURN;
import instructions.control.rtn.DRETURN;
...
import instructions.conversions.i2x.I2B;
import instructions.conversions.i2x.I2C;
import instructions.conversions.i2x.I2D;
import instructions.conversions.i2x.I2F;
import instructions.conversions.i2x.I2L;
import instructions.conversions.i2x.I2S;
...
import instructions.extended.ifnull.IFNONNULL;
import instructions.extended.ifnull.IFNULL;
...
import instructions.math.sh.ISHL;
import instructions.math.sh.ISHR;
import instructions.math.sh.IUSHR;
import instructions.math.sh.LSHL;
import instructions.math.sh.LSHR;
import instructions.math.sh.LUSHR;
...
import instructions.stack.dup.DUP;
import instructions.stack.dup.DUP2;
import instructions.stack.dup.DUP2_X1;
import instructions.stack.dup.DUP2_X2;
import instructions.stack.dup.DUP_X1;
import instructions.stack.dup.DUP_X2;
